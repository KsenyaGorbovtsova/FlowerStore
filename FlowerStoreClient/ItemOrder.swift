...
class ItemOrder: NSObject {
    var itemOrderData = [ItemOrderGateway]()
    func postItemOrder(itemOrderConnection: ItemOrderGateway){
        ItemOrderGateway().sendItemOder(itemOrderConnection: itemOrderConnection)
    }
}
   /*func postItemOrder(itemOrderConnection: itemOrder) {
